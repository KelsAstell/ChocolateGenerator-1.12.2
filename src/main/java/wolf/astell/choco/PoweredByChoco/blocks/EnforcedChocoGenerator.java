...
public class EnforcedChocoGenerator extends Block implements ITileEntityProvider {
	public EnforcedChocoGenerator() {
		super(BlockList.CommonMaterial);
		this.setUnlocalizedName("enforced_choco_generator");
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new GeneratorTE(GeneratorTE.GeneratorTier.ENFORCED);
    }
