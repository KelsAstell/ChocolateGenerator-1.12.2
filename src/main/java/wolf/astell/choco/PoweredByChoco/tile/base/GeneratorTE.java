...
import wolf.astell.choco.PoweredByChoco.energy.generator.FEConnection;
...
public class GeneratorTE extends TileEntity implements ITickable, IInventory, ICapabilityProvider {
	...
	public double limit = Math.min(Double.MAX_VALUE - ModConfig.GENERATOR_CONF.BASIC_ACCUMULATE, Double.MAX_VALUE - ModConfig.GENERATOR_CONF.ENFORCED_ACCUMULATE) - 1;
	...
	private FEConnection fec;

	public GeneratorTE(GeneratorTier tier) {
		this.tier = tier;
		fec = new FEConnection(this, true, false);
	}
	...
	public double calculateEnergy() {
		...
		case REGULAR:
			...
			break;
		case ENFORCED:
			i = ModConfig.GENERATOR_CONF.ENFORCED_ACCUMULATE;
			break;
		default:
			i = 2;
