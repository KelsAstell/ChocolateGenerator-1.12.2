...
public class ContainerChocoGenerator extends Container {

	private GeneratorTE te;

	public ContainerChocoGenerator(IInventory playerInv, GeneratorTE te) {
		this.te = te;

		// Tile Entity, Slot 0, Slot IDs 0 
		this.addSlotToContainer(new CustomSlot(te.getMaxStack(), te, 0, 80, 35));
