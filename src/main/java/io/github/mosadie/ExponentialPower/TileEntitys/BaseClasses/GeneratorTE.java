...
public class GeneratorTE extends TileEntity implements ITickable, IInventory, ICapabilityProvider {
	...
	public double limit = Double.MAX_VALUE - 5;
	...
	public double calculateEnergy() {
		...
		switch (tier) {
		case REGULAR:
			multiplier = ConfigHandler.ender_generator.Regular.ACCUMULATION;
			break;
		case ADVANCED:
			multiplier = ConfigHandler.ender_generator.Advanced.ACCUMULATION;
			break;
		default:
			multiplier = 2;
		}if (ConfigHandler.ender_generator.Regular.MAX_OUTPUT < energy){
			return ConfigHandler.ender_generator.Regular.MAX_OUTPUT;
		}
		if (limit < energy){
			return energy;
		}
